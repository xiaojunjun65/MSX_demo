...
def parse_args():
    ...
    #output path
    parser.add_argument("--output_dir", type=str, help="文件输出路径")  # ./runs
    parser.add_argument("--log_dir", type=str, help="log输出路径")  # ./runs
    ...
    parser.add_argument("--input_size", type=int, default=224, help="输入网络模型的尺寸")
    ...
    #splitdata
    parser.add_argument("--dataset_path", type=str, help="数据集地址")
    ...
    parser.add_argument("--batch_size", type=int, default=128, help="批次数")
    parser.add_argument("--num_workers", type=int, default=4, help="多少个进程处理数据")
